...
def test_mls_comprehensive(dtype, config_list, layout_combination,
    ...
    # 2> HW issue: for gfx938, when matrix_load with mfilter|nfilter = dim size, result is incorrect.
...
# TOPS. REF/MLS are historical reference columns; gfx936 does not support FP8.
...
# |---------|------|---------|----------------|---------|---------|-----------|------------|---------|---------------|----------|----------|---------|
# | gfx938  | FP16 | row-col | 4096^3         | 270.890 | 216.644 |   209.204 |    209.204 | 246.870 |             - |        - |   +0.00% | +18.00% |
# | gfx938  | FP16 | row-col | 5120^3         | 265.211 | 200.841 |   208.542 |    208.542 | 260.553 |       211.220 | 262.357† |   +0.00% | +24.94% |
# | gfx938  | FP16 | row-col | 8192^3         | 280.225 | 171.046 |   204.754 |    204.754 | 275.738 |       203.609 |  274.343 |   +0.00% | +34.67% |
# | gfx938  | FP16 | row-col | 16384^3        | 218.951 | 155.281 |   191.312 |    191.312 | 193.120 |       184.392 |  284.439 |   +0.00% |  +0.95% |
# | gfx938  | FP16 | row-row | 4096^3         | 295.390 | 230.417 |   193.032 |    213.440 | 233.110 |       215.050 | 232.878† |  +10.57% |  +9.22% |
# | gfx938  | FP16 | row-row | 5120^3         | 314.239 | 257.774 |   199.741 |    228.693 | 247.337 |       228.044 | 248.213† |  +14.49% |  +8.15% |
# | gfx938  | FP16 | row-row | 8192^3         | 245.963 | 277.699 |   201.914 |    226.188 | 262.267 |       226.133 |  259.694 |  +12.02% | +15.95% |
# | gfx938  | FP16 | row-row | 16384^3        | 218.800 | 221.737 |   206.809 |    229.864 | 280.397 |       229.712 |  278.127 |  +11.15% | +21.98% |
# | gfx938  | FP16 | row-col | 4096x4096x4064 |       - |       - |         - |          - | 244.581 |             - |        - |        - |       - |
# | gfx938  | BF16 | row-col | 4096x4096x4064 |       - |       - |   211.146 |    211.175 | 242.525 |             - |        - |   +0.01% | +14.85% |
# | gfx938  | FP16 | row-row | 4096x4096x4064 |       - |       - |         - |          - | 232.629 |             - |        - |        - |       - |
# | gfx938  | BF16 | row-row | 4096x4096x4064 |       - |       - |   184.875 |    212.888 | 230.357 |             - |        - |  +15.15% |  +8.21% |
# | gfx936  | FP16 | row-col | 4096^3         | 322.930 |       - |   221.262 |    221.253 | 277.426 |       221.117 | 277.453† |   -0.00% | +25.39% |
# | gfx936  | FP16 | row-col | 5120^3         | 371.383 |       - |   271.305 |    271.275 | 328.345 |             - |        - |   -0.01% | +21.04% |
# | gfx936  | FP16 | row-col | 8192^3         | 381.404 |       - |   275.800 |    275.734 | 357.098 |       275.329 |  358.910 |   -0.02% | +29.51% |
# | gfx936  | FP16 | row-col | 16384^3        | 298.484 |       - |   279.571 |    277.670 | 202.853 |       266.726 |  284.017 |   -0.68% | -26.94% |
# | gfx936  | FP16 | row-row | 4096^3         | 341.684 |       - |   207.576 |    233.544 | 263.963 |             - |        - |  +12.51% | +13.02% |
# | gfx936  | FP16 | row-row | 5120^3         | 415.999 |       - |   239.373 |    274.894 | 332.706 |             - |        - |  +14.84% | +21.03% |
# | gfx936  | FP16 | row-row | 8192^3         | 325.376 |       - |   242.479 |    290.825 | 346.620 |       291.018 |  346.819 |  +19.94% | +19.19% |
# | gfx936  | FP16 | row-row | 16384^3        | 275.414 |       - |   250.327 |    277.965 | 346.883 |       278.335 |  347.974 |  +11.04% | +24.79% |
# | gfx936  | FP16 | row-col | 4096x4096x4064 |       - |       - |         - |          - | 265.146 |             - |        - |        - |       - |
# | gfx936  | BF16 | row-col | 4096x4096x4064 |       - |       - |         - |          - | 260.888 |             - |        - |        - |       - |
# | gfx936  | FP16 | row-row | 4096x4096x4064 |       - |       - |         - |          - | 260.519 |             - |        - |        - |       - |
# | gfx936  | BF16 | row-row | 4096x4096x4064 |       - |       - |         - |          - | 255.459 |             - |        - |        - |       - |
#
...
# |---------|------|---------|----------------|-----------|--------------------|---------|---------------|----------|----------|---------|
# | gfx938  | FP8  | row-col | 4096^3         |   405.686 |            405.725 | 448.945 |             - |        - |   +0.01% | +10.65% |
# | gfx938  | FP8  | row-col | 5120^3         |   417.604 |            417.747 | 485.424 |             - |        - |   +0.03% | +16.20% |
# | gfx938  | FP8  | row-col | 8192^3         |   436.989 |            437.032 | 539.615 |             - |        - |   +0.01% | +23.47% |
# | gfx938  | FP8  | row-col | 16384^3        |   477.404 |            477.600 | 405.250 |       479.911 |  415.728 |   +0.04% | -15.15% |
# | gfx938  | FP8  | row-row | 4096^3         |   346.346 |            395.568 | 439.220 |             - |        - |  +14.21% | +11.04% |
# | gfx938  | FP8  | row-row | 5120^3         |   373.201 |            427.356 | 480.788 |             - |        - |  +14.51% | +12.50% |
# | gfx938  | FP8  | row-row | 8192^3         |   393.103 |            432.161 | 530.075 |       431.011 | 529.814† |   +9.94% | +22.66% |
# | gfx938  | FP8  | row-row | 16384^3        |   411.009 |            491.909 | 588.840 |       495.811 |  551.779 |  +19.68% | +19.71% |
# | gfx938  | FP8  | row-col | 4096x4096x4064 |   378.337 |            378.342 | 347.262 |             - |        - |   +0.00% |  -8.21% |
# | gfx938  | FP8  | row-row | 4096x4096x4064 |   332.410 |            368.291 | 414.914 |             - |        - |  +10.79% | +12.66% |
# | gfx938  | INT8 | row-col | 4096^3         |   403.381 |            402.641 | 443.487 |             - |        - |   -0.18% | +10.14% |
# | gfx938  | INT8 | row-col | 5120^3         |   414.784 |            414.801 | 482.164 |             - |        - |   +0.00% | +16.24% |
# | gfx938  | INT8 | row-col | 8192^3         |   435.252 |            435.206 | 536.498 |             - |        - |   -0.01% | +23.27% |
# | gfx938  | INT8 | row-col | 16384^3        |   476.294 |            476.294 | 406.657 |       478.715 |  411.955 |   +0.00% | -14.62% |
# | gfx938  | INT8 | row-row | 4096^3         |   344.243 |            391.968 | 437.183 |             - |        - |  +13.86% | +11.54% |
# | gfx938  | INT8 | row-row | 5120^3         |   370.996 |            424.277 | 477.862 |             - |        - |  +14.36% | +12.63% |
# | gfx938  | INT8 | row-row | 8192^3         |   391.503 |            430.102 | 527.157 |       428.870 | 526.958† |   +9.86% | +22.57% |
# | gfx938  | INT8 | row-row | 16384^3        |   409.738 |            490.606 | 588.186 |       494.472 |  552.677 |  +19.74% | +19.89% |
# | gfx938  | INT8 | row-col | 4096x4096x4064 |   375.027 |            374.970 | 344.830 |             - |        - |   -0.02% |  -8.04% |
# | gfx938  | INT8 | row-row | 4096x4096x4064 |   329.790 |            365.209 | 411.086 |             - |        - |  +10.74% | +12.56% |
# | gfx936  | INT8 | row-col | 4096^3         |         - |            349.175 | 479.981 |             - |        - |        - | +37.46% |
# | gfx936  | INT8 | row-col | 5120^3         |         - |            393.548 | 523.494 |             - |        - |        - | +33.02% |
# | gfx936  | INT8 | row-col | 8192^3         |         - |            469.472 | 667.789 |       469.492 | 668.217† |        - | +42.24% |
# | gfx936  | INT8 | row-col | 16384^3        |         - |            546.512 | 488.961 |       552.412 |  488.425 |        - | -10.53% |
# | gfx936  | INT8 | row-row | 4096^3         |         - |            427.134 | 474.193 |             - |        - |        - | +11.02% |
# | gfx936  | INT8 | row-row | 5120^3         |         - |            473.501 | 573.054 |             - |        - |        - | +21.02% |
# | gfx936  | INT8 | row-row | 8192^3         |         - |            540.676 | 663.887 |             - |        - |        - | +22.79% |
# | gfx936  | INT8 | row-row | 16384^3        |         - |            556.117 | 640.992 |       555.688 |  706.228 |        - | +15.26% |
# | gfx936  | INT8 | row-col | 4096x4096x4064 |         - |            337.369 | 365.678 |             - |        - |        - |  +8.39% |
# | gfx936  | INT8 | row-row | 4096x4096x4064 |         - |            392.356 | 399.880 |             - |        - |        - |  +1.92% |
#
...
# |---------|------|------------------------|--------------------------------|--------|
# | gfx938 | FP8  | 415.728 TOPS (M256_N128, A only) | 597.038 TOPS (A+B) | +43.61% |
# | gfx938 | INT8 | 411.955 TOPS (M128_N256, B only) | 595.314 TOPS (A+B) | +44.51% |
# | gfx936 | INT8 | 488.425 TOPS (M256_N128, A only) | 708.635 TOPS (A+B) | +45.09% |
#
# Safe-review recheck on gfx938 (2026-08-19): BF16 row-col 4096x4096x4064
