...
// In the bundled ROCm headers, hipDeviceProp_t is #defined to hipDeviceProp_tR0600,
// and the DTK hipDeviceProp_t_v2 has the same layout. We use hipDeviceProp_t
// (which resolves to the R0600/v2 layout) for the function pointer signature.
