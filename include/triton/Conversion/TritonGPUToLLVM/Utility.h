...
inline void emitBaseIndexForMmacLayout(Location loc, RewriterBase &rewriter,
  ...
  case MfmaMmacLayout::MMAC_DEFAULT: {
    ...
    multiDimBase[rank - 1] =
        b.add(b.mul(b.i32_val(1), b.udiv(laneId, b.i32_val(mDim))), offWarp1);
    break;
  }
  case MfmaMmacLayout::MMAC_TRANSPOSE: {
    multiDimBase[rank - 1] = b.add(b.urem(laneId, b.i32_val(mDim)), offWarp1);
    multiDimBase[rank - 2] =
        b.add(b.mul(b.i32_val(1), b.udiv(laneId, b.i32_val(mDim))), offWarp0);
    break;
  }
  ...
  case MfmaMmacLayout::MMAC_4INTERLEAVE_TRANSPOSE: {
    multiDimBase[rank - 1] = b.add(b.urem(laneId, b.i32_val(mDim)), offWarp1);
    multiDimBase[rank - 2] =
        b.add(b.mul(b.i32_val(4), b.udiv(laneId, b.i32_val(mDim))), offWarp0);
    break;
  }
