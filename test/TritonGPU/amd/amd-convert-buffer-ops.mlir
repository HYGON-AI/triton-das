// RUN: triton-opt %s -split-input-file --tritonamdgpu-convert-buffer-ops="arch-generation-name=gfx942 analyze-small-tensor-ofst=true use-range-analysis=true"| FileCheck %s --check-prefixes=COMMON,GFX942-ONLY
// RUN: triton-opt %s -split-input-file --tritonamdgpu-convert-buffer-ops="arch-generation-name=gfx950 analyze-small-tensor-ofst=true use-range-analysis=true"| FileCheck %s --check-prefixes=COMMON,GFX950-ONLY
